...
class T:#Triangulo
    def __init__(self,p1,p2,p3): #angulo, lados
        self.p1 = p1
        self.p2 = p2
        self.p3 = p3
...
def Translacion2(p1,p2,p3,pb):# puntos a transladar
    return [Sum(p1,pb),Sum(p2,pb),Sum(p3,pb)]
...
#traslada e imprime un triangulo
...
#rotacion de triangulo
puntos_rotados = [Rote(puntos_trasladados[0],angulo),Rote(puntos_trasladados[1],angulo),Rote(puntos_trasladados[2],angulo)]
triangulo_rotado = T(puntos_rotados[0],puntos_rotados[1],puntos_rotados[2])
imprimeTriangulo(triangulo_rotado,BLANCO,1)

#traslada e imprime un triangulo rotado
puntos_trasladados2 = Translacion2(puntos_rotados[0],puntos_rotados[1],puntos_rotados[2],pb)
triangulo_trasladado2 = T(puntos_trasladados2[0],puntos_trasladados2[1],puntos_trasladados2[2])
imprimeTriangulo(triangulo_trasladado2,AZUL,1)
